...
<Accordion title={"Why are some companies skipped during auto research?"}>
  Companies are skipped when their existing answer is still fresh according to the refresh policy. If you need to force a full re-evaluation, use the manual trigger with the resync option.
</Accordion>
