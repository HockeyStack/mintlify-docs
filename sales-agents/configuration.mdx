...
Configure which AI properties the system evaluates during company research for prospecting.
...
Choose properties that inform **personalization and timing** — signals that help the AI tailor outreach content or decide when to reach out. Good examples: "Is this company actively hiring for relevant roles?", "Has this company recently raised funding?", "What technology stack do they use?"

Avoid adding fit-related properties here (e.g., industry, employee count, revenue range). Fit is already assessed by your [Account Segments](/sales-agents/account-segments) — the AI uses segments to decide *which* accounts to target. The Signals tab controls what the AI researches to decide *how* to personalize outreach to those accounts.
