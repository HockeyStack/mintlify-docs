...
Stakeholder Discovery maps key contacts at your target accounts based on your persona definitions. You can trigger discovery in two ways:

- **Per sales view** — Open the configuration dropdown on a sales view and select **Generate Stakeholder Maps** to discover contacts across all companies in the view.
- **Per company** — Navigate to a company's People tab and click **Re-generate** to discover contacts for that specific account.

Test discovery on a single company first to validate your persona definitions, then run across a full view.
