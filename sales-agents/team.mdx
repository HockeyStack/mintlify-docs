...
User roles, access levels, and the reporting hierarchy that powers this page are all configured in **Workspace Settings > Team**. See [Users and Roles](/sales-agents/configuration/users-and-roles) for full details on setup.
...
<Accordion title={"How do I change a team member's role?"}>
  Navigate to **Workspace Settings > Team** to manage role assignments. See [Users and Roles](/sales-agents/configuration/users-and-roles).
</Accordion>
</AccordionGroup>