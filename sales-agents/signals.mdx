...
<Accordion title={"Why does the score reasoning mention \"strengths\" I don't agree with?"}>
  Score reasoning is generated from the scoring model's analysis. If the reasoning seems off, review the scoring configuration to ensure the features and weights reflect your actual ICP criteria.
</Accordion>
