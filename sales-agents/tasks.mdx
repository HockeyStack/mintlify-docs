...
Chat history is preserved per task. When you return to the same task later, previous messages are loaded. Click **New Chat** to clear the history and start fresh.
