...
- **Output type:** Enum
- **Values:** AWS, GCP, Azure, Multi-cloud, On-premise, Unknown
...
- **Output type:** Enum
- **Values:** [Competitor A], [Competitor B], [Competitor C], Multiple, None detected, Unknown
...
- **Output type:** Enum
- **Values:** Under $10M, $10M–$50M, $50M–$200M, $200M–$1B, Over $1B, Unknown
...
- **Output type:** Enum
- **Values:** Founder-led sales, Small team (1–5 reps), Mid-size team (6–20 reps), Large team (20+ reps), Unknown
...
3. Select the matching **output type** (and add enum values if applicable).
