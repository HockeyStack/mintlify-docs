...
| ------------------------------- | -------------------------------------------------------------------------------------------------- |
| **Stakeholder Mapping**         | Identifies and categorizes key people at accounts based on persona matches. Configured in the **Stakeholder Mapping** tab of the Personas modal. See [Stakeholder Discovery](/sales-agents/stakeholder-discovery). |
...
<AccordionGroup>
<Accordion title={"How long before a new persona takes effect?"}>
...
<Accordion title={"Can I use the same persona across multiple motions?"}>
...
<Accordion title={"What happens to existing tasks when I edit a persona?"}>
...
<Accordion title={"Why aren't contacts being discovered for my persona?"}>
...
<Accordion title={"Can I create personas during workflow configuration?"}>
...
<Accordion title={"How do keywords interact with department and job level filters?"}>
